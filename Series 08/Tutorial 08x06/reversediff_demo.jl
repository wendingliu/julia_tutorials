...
# ╔═╡ 885b04bb-da4b-4ad6-9140-2bb10c2b4eef
using ReverseDiff

# ╔═╡ 95cd8b02-14e9-4b94-9384-62a9a3fbf250
md"# Reverse Mode Automatic Differentiation"

# ╔═╡ ee843bb3-a104-40a8-9ba9-1d5915abcf2a
...
# ╔═╡ c9d12c54-e36c-4ae5-8f97-4ed71caed168
md"## Load Package"

# ╔═╡ 51a906f9-1314-43c9-95e3-1b3b5f6934c2
md"## Define Function"

# ╔═╡ 76a910fd-604d-4099-91e5-07a130080b4a
f(A, B) = sum(A' * B + A * B')

# ╔═╡ 7b0efd26-c9e1-49ef-933c-b58a73a4c9c9
md"## Generate Inputs by using Random Numbers"

# ╔═╡ e260ff12-68e3-4dd9-98b0-6657b9af3069
A, B = rand(100, 100), rand(100, 100)

# ╔═╡ ff7026eb-0817-4193-afbb-59baaa7230a5
c = f(A, B)

# ╔═╡ 7c1c409c-7b49-4e8d-8145-8b2fc847dd10
inputs = (A, B)

# ╔═╡ 182ce130-14d3-479f-a572-eb226aefb01c
md"## Find Gradient"

# ╔═╡ c37196a1-1c69-4ff1-b60b-b69904161be3
md"""
...
# ╔═╡ 63d6bfe5-8d96-4fe7-b40a-b60a297a2882
a, b = ReverseDiff.gradient(f, inputs)

# ╔═╡ 380b8c34-28a7-451f-b6aa-0329e5cf3d58
a

# ╔═╡ c7534f60-2386-4d35-aff6-a7ee30743259
b

# ╔═╡ d370bdbe-42e3-41c0-98cd-077655c59497
md"Note: See GitHub repository for more optimal examples."

# ╔═╡ 771f38df-1d7e-4541-a428-efed934201fa
...
manifest_format = "2.0"
project_hash = "43ab25594c055f6d19b006c9ef4733d984d6d0c8"
