...
# ╔═╡ 5e6264fd-ce08-46a1-9190-e3b84c631e18
using Symbolics, SymbolicNumericIntegration

# ╔═╡ 3e9988b0-beb9-11ed-2203-1beed5cab489
md"# SymbolicNumericIntegration.jl Demo"

# ╔═╡ 4fda2079-b21b-4364-be27-913fa53b2afb
md"""Citation: [Iravanian et al. "Symbolic-Numeric Integration of Univariate Expressions based on Sparse Regression". arXiv, February 6, 2022.](https://arxiv.org/abs/2201.12468v2)"""

# ╔═╡ 58e926e9-74b2-4798-8767-cedebde5ab3f
md"## Load Packages"

# ╔═╡ 93b1c90a-eea8-4166-8af5-be2791410c87
md"## Define Symbolic Variable"

# ╔═╡ ff6eedf8-bcc5-46a9-ac14-2ca58688004a
@variables x

# ╔═╡ 238b80f9-086f-405c-8b17-b4a7d0d02048
md"Note: Currently, the SymbolicNumericIntegration.jl package only works expressions containing a single variable."

# ╔═╡ b9e0bbb3-5c3a-4939-a354-cf43044c5a5f
md"## Example from Documentation"

# ╔═╡ 2d4899a0-9b5e-4a61-a114-e668bb661cd8
ex1 = 3 * x^3 + 2 * x - 5

# ╔═╡ 4197b133-7ac3-4e3a-bcc6-f944a5aa0bcf
integrate(ex1)

# ╔═╡ 6e9152a9-4af2-4f2a-9090-24fc4acc9aa5
integrate(ex1)[1]

# ╔═╡ 31f74e96-b377-42e9-9e00-00e89a8c3af0
md"## Example from Episode 807"

# ╔═╡ 5e071337-f7d9-48a0-bca0-30ac4d396d51
f = sqrt(x)

# ╔═╡ d46f3dbe-b41a-4f9a-a96d-0ff67cd598aa
integrate(f)

# ╔═╡ e0ab2414-d546-4485-8b57-475c4c103c11
to_compute = integrate(f)[1]

# ╔═╡ 79566b58-8794-444b-911b-c29d5aa14788
f_expr = build_function(to_compute, x)

# ╔═╡ 0eac1ecc-b166-420c-8559-9fd54a9d92fb
myf = eval(f_expr)

# ╔═╡ 2ee7905c-930f-4721-871a-a094f7464372
area = myf(4)

# ╔═╡ e4a0e382-b290-42c7-af5d-d0a47483b41a
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "8b704e1188dfbf3d8453810dbfe37baf42ffc0c8"
...
git-tree-sha1 = "cef2dd16402718cf5f412e610813e2ec20d94a64"
